  ...
  <main>
    ...
    <section class="w-full mb-8 py-14 text-center text-white relative">
      ...
      <div class="container mx-auto flex items-center">
        <!-- Play/Pause Button -->
        <button @click.prevent="newSong(song)" id="play-btn"
                type="button"
    ...
    <section id="comments" class="container mx-auto mt-6">
      ...
      >
        ...
        <div class="p-6">
          <div class="text-white text-bold p-4 mb-4" v-if="comment_show_alert" :class="comment_alert_variant">
...
export default {
  ...
  data() {
    return {
      ...
      songgenre: "",
      schema: {
        comment: 'required|min:9|max:100',
      },
      comment_in_submission: false,
      comment_alert_variant: "bg-purple-500",
  ...
  async created() {
    ...
    this.name = this.song.modified_name;
  ...
  methods: {
    ...
    async addComment(values, {resetForm}) {
      ...
      this.comment_alert_variant = "bg-purple-500";
      ...
      this.comment_alert_message = "added";
